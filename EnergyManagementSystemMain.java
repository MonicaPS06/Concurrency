...
public class EnergyManagementSystemMain {
    ...
    public static void main(String[] args) {
        ...
        // Create different types of devices consuming energy from the battery
        BatteryUsageSimulator highPowerDevice = new BatteryUsageSimulator(battery, 20, "HighPowerDevice", false);
        BatteryUsageSimulator lowPowerDevice = new BatteryUsageSimulator(battery, 5, "LowPowerDevice", false);
        BatteryUsageSimulator variablePowerDevice = new BatteryUsageSimulator(battery, 15, "VariablePowerDevice", true);
